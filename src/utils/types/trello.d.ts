...
// Slightly edited by: Jose M. https://github.com/jmnuf/
...
export namespace Trello {
  interface PowerUp {
    ...
    PostMessageIO: (e)=>any; // PostMessageIO
    ...
    restApiError(message:string): { message: typeof message, name: string, stack: string };
    util: PowerUp.Util;
  }
  ...
  namespace PowerUp {
    ...
    type CapabilityHandlers = {
      "attachment-sections"?: (t: PowerUp.IFrame, options: {
        entries: Attachment[];
      }) => PromiseLike<(AttachmentSection | LazyAttachmentSection)[]>|(AttachmentSection | LazyAttachmentSection)[];
      "attachment-thumbnail"?: () => PromiseLike<void>|void;
      "board-buttons"?: (t: PowerUp.IFrame) => PromiseLike<(BoardButtonUrl | BoardButtonCallback)[]>|(BoardButtonUrl | BoardButtonCallback)[];
      "card-back-section"?: (t: PowerUp.IFrame) => PromiseLike<CardBackSection>|CardBackSection;
      "card-badges"?: (t: PowerUp.IFrame) => PromiseLike<(CardBadgeDynamic | CardBadge)[]>|(CardBadgeDynamic | CardBadge)[];
      "card-buttons"?: (t: PowerUp.IFrame) => PromiseLike<CardButton[]>|CardButton[];
      "card-detail-badges"?: (t: PowerUp.IFrame) => PromiseLike<(CardDetailBadgeDynamic | CardDetailBadge)[]>|(CardDetailBadgeDynamic | CardDetailBadge)[];
      "card-from-url"?: () => PromiseLike<void>|void;
      "format-url"?: () => PromiseLike<void>|void;
      ...
      "on-enable"?: (t: PowerUp.IFrame) => PromiseLike<void>|void;
      "on-disable"?: () => PromiseLike<void>|void;
      "remove-data"?: () => PromiseLike<void>|void;
      "show-settings"?: (t: PowerUp.IFrame) => PromiseLike<void>|void;
      "authorization-status"?: () => PromiseLike<void>|void;
      "show-authorization"?: () => PromiseLike<void>|void;
    };
    ...
    interface AnonymousHostHandlers {
      ...
      get<T,V=undefined>(scope: Scope | string, visibility: Visibility, key?: string, defaultValue?: V): PromiseLike<T|V>;
    ...
    interface HostHandlers extends AnonymousHostHandlers {
      getContext(): Context;
			NotHandled(message?:string): Error;
